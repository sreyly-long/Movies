...
const Popular = () =>{
    ...
    return(
        ...
        <div className="row">
            {
               popular && popular.map(populars=> (
                    <Cards poster_path={`https://image.tmdb.org/t/p/w440_and_h660_face/` +populars.poster_path} title={populars.title} release_date={populars.release_date} />
                ))
            }
        </div>
    </section>
